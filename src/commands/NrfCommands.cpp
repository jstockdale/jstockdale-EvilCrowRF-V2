/**
 * @file NrfCommands.cpp
 * @brief NRF24 command handler implementations.
 *
 * Extracted from NrfCommands.h to reduce header bloat and
 * improve incremental build times.
 */

#include "NrfCommands.h"

void NrfCommands::registerCommands(CommandHandler& handler) {
...
bool NrfCommands::handleInit(const uint8_t* data, size_t len) {
...
bool NrfCommands::handleScanStart(const uint8_t* data, size_t len) {
...
// ── 0x22: Stop scan ─────────────────────────────────────────
bool NrfCommands::handleScanStop(const uint8_t* data, size_t len) {
    MouseJack::stopScan();
...
bool NrfCommands::handleScanStatus(const uint8_t* data, size_t len) {
...
bool NrfCommands::handleAttackHid(const uint8_t* data, size_t len) {
    if (len < 3) {
...
bool NrfCommands::handleAttackString(const uint8_t* data, size_t len) {
    if (len < 3) {
...
bool NrfCommands::handleAttackDucky(const uint8_t* data, size_t len) {
    if (len < 3) {
        uint8_t resp[] = { MSG_COMMAND_ERROR, 2 };
        ClientsManager::getInstance().notifyAllBinary(
            NotificationType::NrfEvent, resp, sizeof(resp));
...
// ── 0x27: Stop attack ───────────────────────────────────────
bool NrfCommands::handleAttackStop(const uint8_t* data, size_t len) {
...
bool NrfCommands::handleSpectrumStart(const uint8_t* data, size_t len) {
...
bool NrfCommands::handleSpectrumStop(const uint8_t* data, size_t len) {
    NrfSpectrum::stop();
    uint8_t resp[] = { MSG_COMMAND_SUCCESS };
    ClientsManager::getInstance().notifyAllBinary(
        NotificationType::NrfEvent, resp, sizeof(resp));
...
bool NrfCommands::handleJamStart(const uint8_t* data, size_t len) {
...
// ── 0x2B: Stop jammer ───────────────────────────────────────
bool NrfCommands::handleJamStop(const uint8_t* data, size_t len) {
    NrfJammer::stop();
    uint8_t resp[] = { MSG_COMMAND_SUCCESS };
    ClientsManager::getInstance().notifyAllBinary(
        NotificationType::NrfEvent, resp, sizeof(resp));
...
// Payload: [mode:1]
bool NrfCommands::handleJamSetMode(const uint8_t* data, size_t len) {
...
// Payload: [channel:1]
bool NrfCommands::handleJamSetChannel(const uint8_t* data, size_t len) {
    if (len < 1) return false;
...
bool NrfCommands::handleClearTargets(const uint8_t* data, size_t len) {
...
bool NrfCommands::handleStopAll(const uint8_t* data, size_t len) {
...
bool NrfCommands::handleNrfSettings(const uint8_t* data, size_t len) {
    if (len < 4) {
...
bool NrfCommands::handleJamSetDwell(const uint8_t* data, size_t len) {
    if (len < 2) {
        uint8_t resp[] = { MSG_COMMAND_ERROR, 2 };
        ClientsManager::getInstance().notifyAllBinary(
            NotificationType::NrfEvent, resp, sizeof(resp));
...
bool NrfCommands::handleJamModeConfig(const uint8_t* data, size_t len) {
    if (len < 1) {
        uint8_t resp[] = { MSG_COMMAND_ERROR, 2 };
        ClientsManager::getInstance().notifyAllBinary(
            NotificationType::NrfEvent, resp, sizeof(resp));
...
bool NrfCommands::handleJamModeInfo(const uint8_t* data, size_t len) {
    if (len < 1) {
        uint8_t resp[] = { MSG_COMMAND_ERROR, 2 };
        ClientsManager::getInstance().notifyAllBinary(
            NotificationType::NrfEvent, resp, sizeof(resp));
...
bool NrfCommands::handleJamResetConfig(const uint8_t* data, size_t len) {
